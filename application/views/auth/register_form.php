			...
			<div class="box01">
				<div class="login-window">
					...
					<div id="connect-with-buttons">
						<a href="<?php echo site_url() ?>begin_auth/auth_oa2/session/facebook" class="connect-with-button account-sprites account-sprites-facebook" title="Facebook Connect"></a>
